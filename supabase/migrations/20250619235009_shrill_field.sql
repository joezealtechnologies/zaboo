-- FaZona EV Database Setup for cPanel
-- Run this in your cPanel MySQL interface
...
(
    ...
    '₦20 million',
    '200km per charge',
    'Our flagship electric vehicle with premium features and extended range.',
...
(
    ...
    '₦9.5 million',
    '100km per charge',
    'Ideal for city driving with essential features.',
...
(
    ...
    '₦6.5 million',
    '80km per charge',
    'Affordable entry-level electric vehicle.',
